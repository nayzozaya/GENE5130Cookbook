...
```{r setup}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("~/Documents/bioinformaticsinR /data")) 
```
...
counts <- GSE152418RawCounts
metadata <- GSE152418Metadata
...
# Step 2: Install both GO.db and impute
BiocManager::install(c("GO.db", "impute"))

BiocManager::install("preprocessCore")

# Force install of GO.db again (in case it failed silently)
